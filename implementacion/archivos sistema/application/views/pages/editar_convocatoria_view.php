...
<script type="text/javascript">
	var idConvocatoria = "<?php echo($idConvocatoria) ?>";
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/editarConvcatoria.js"></script> 
	...
	<div class="contenido center">
		<form class="margin-sup" id="editarRegistroConvocatoria">
			<div class="margin">
				<span class="etiqueta esconder">Responsable del proyecto:</span>
				<input type="text" name="folioProdep" placeholder="número Folio PRODEP del proyecto" class="textbox tamanoBtn" id="folioProdep" required>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
				 	 <div class="margin">
						...
						<input type="hidden" name="idcartaPresentacion" value="" id="idcartaPresentacion">
						</div>
					 <div class="margin">
						<h4><input type="checkbox" id="constanciaEstudios">Constancia de estudios</h4>
						<input type="hidden" name="idconstanciaEstudios" value="" id="idconstanciaEstudios">
						</div>
				 	<div class="margin">
						<h4><input type="checkbox" id="actaNacimiento">Acta de nacimiento</h4>
						<input type="hidden" name="idactaNacimiento" value="" id="idactaNacimiento">
					</div>
					<div class="margin">
						<h4><input type="checkbox" id="credenciaElector">Credencial de elector</h4>
						<input type="hidden" name="idcredenciaElector" value="" id="idcredenciaElector">
					</div>
					<div class="margin">
						<h4><input type="checkbox" id="curp">CURP</h4>
						<input type="hidden" name="idcurp" value="" id="idcurp">
											</div>
					<div class="margin">
						<h4><input type="checkbox" id="rfc">RFC</h4>
						<input type="hidden" name="idrfc" value="" id="idrfc">
					</div>
					 <div class="margin">
						<h4><input type="checkbox" id="cartaCompromiso">Carta compromiso</h4>
						<input type="hidden" name="idcartaCompromiso" value="" id="idcartaCompromiso">
					</div>
					 <div class="margin">
						<h4><input type="checkbox" id="numeroCuenta">Número de cuenta</h4>
						<input type="hidden" name="idnumeroCuenta" value="" id="idnumeroCuenta">
					</div>
				</div>
